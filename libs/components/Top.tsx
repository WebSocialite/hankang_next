...
// import { NotificationMessage } from '../types/notification/notification';
								...
								<>
									...
									>
										<MenuItem onClick={() => logOut()}>
											<Logout fontSize="small" style={{ color: '#33c1c1', marginRight: '10px' }} />
											Logout
										</MenuItem>
									</Menu>
								</>
							...
							<div className={'lan-box'}>
													...
													return (
														<MenuItem
															...
															style={{
																whiteSpace: 'normal',
																wordWrap: 'break-word',
																backgroundColor: isRead ? '#dcd2f7' : '#f5a4c4',
																borderRadius: 20,
																padding: '10px',
																margin: 10,
															}}
								...
								<StyledMenu anchorEl={anchorEl2} open={drop} onClose={langClose} sx={{ position: 'absolute' }}>
									<MenuItem disableRipple onClick={langChoice} id="en">
										<img className="img-flag" src={'/img/'} onClick={langChoice} id="en" alt={'usaFlag'} />
										{t('English')}
									</MenuItem>
