				...
				<Box component={'div'} className={'info'}>
					...
					<div className={'bott'}>
						...
						<div className="view-like-box">
							...
							<IconButton color={'default'} onClick={(e: any) => {
								console.log('======////////>', e);
		...
		return (
			<Stack className="trend-card-box" key={property._id}>
				<Box
					...
					onClick={() => pushDetailHandler(property._id)}
				>
					<Box component={'div'} className={'info'} onClick={(e: { stopPropagation: () => any; }) => e.stopPropagation()}>
					<strong className={'title'}
					>{property.propertyTitle}</strong>
					<p className={'desc'}>{property.propertyDesc ?? 'no description'}</p>
					{/* <div className={'options'}> */}
						{/* <div>
							<img className="asd" src="/img/icons/bed.svg" alt="" />
							<span>{property.propertyBeds} bed</span>
						</div> */}
						{/* <div>
							<img src="/img/icons/room.svg" alt="" />
					...
					<div className={'bott'}>
						...
						<div className="view-like-box">
							...
							<Typography className="view-cnt">{property?.propertyViews}</Typography>
							<IconButton color={'default'} onClick={(e: any) => likePropertyHandler(e, user, property?._id)}>
								{property?.meLiked && property?.meLiked[0]?.myFavorite ? (
									<FavoriteIcon style={{ color: 'red' }} />
								) : (
									<FavoriteIcon />
